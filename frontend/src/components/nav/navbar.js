            ...
            return (
                <div className="hidden fixed inset-0 h-full pt-24 z-90 w-full border-b lg:-mb-0 lg:static lg:h-auto lg:bg-white lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:block lg:border-0 lg:w-64 shadow-lg">
                    <div className="h-full overflow-y-auto scrolling-touch lg:h-screen lg:block lg:relative lg:sticky lg:top-0 bg-gray-100 lg:bg-transparent overflow-hidden">
                        <div className="flex flex-col w-full text-gray-700 flex-shrink-0">
                            <div className="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
                                <a href="#" className="text-lg font-bold tracking-widest text-gray-900 rounded-lg focus:outline-none focus:shadow-outline">p2p</a>
                            ...
                            <nav className="flex-grow px-4 pb-4 md:pb-0 md:overflow-y-auto">
                                <Link to={'/post'} className="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
                                ...
                                <Link to={'/new_post'} className="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
                                ...
                                <Link to={'/profile'} className="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
            ...
            return (
                <div className="hidden fixed inset-0 h-full pt-24 z-90 w-full border-b lg:-mb-0 lg:static lg:h-auto lg:bg-white lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:block lg:border-0 lg:w-64 shadow-lg">
                    <div className="flex flex-col w-full text-gray-700 flex-shrink-0">
                        ...
                        <nav className="flex-grow px-4 pb-4 md:pb-0 md:overflow-y-auto">
                            <Link to={'/login'} className="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
                                <svg className="inline-block align-middle mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M13 20v-5h-2v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7.59l-.3.3a1 1 0 1 1-1.4-1.42l9-9a1 1 0 0 1 1.4 0l9 9a1 1 0 0 1-1.4 1.42l-.3-.3V20a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2zm5 0v-9.59l-6-6-6 6V20h3v-5c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v5h3z" /></svg>
                                <span className="inline-block align-middle">Login</span>
                            </Link>

                            <Link to={'/signup'} className="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
                                <svg className="inline-block align-middle mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm1-9h2a1 1 0 0 1 0 2h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V9a1 1 0 0 1 2 0v2z" /></svg>
